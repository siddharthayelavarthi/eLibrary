	...
	<div class="navbar navbar-fixed-top navbar-inverse">
            <div class="navbar-inner">
                <div class="container">
					...
					<li class="divider-vertical"></li>
					<li class="">
					<a rel="tooltip"  data-placement="bottom" title="Click Here to About" id="login" href="librarian"><i class="icon-user icon-large"></i>&nbsp;Admin login</a>
					</li>
					<li class="divider-vertical">
					<a rel="tooltip"  data-placement="bottom" title="Click Here to About" id="login" href="member"><i class="icon-user icon-large"></i>&nbsp;Member Login</a>
					</li>
