			...
			<div class="span12">	
			   <div class="alert alert-info">
                ...
                <table cellpadding="0" cellspacing="0" border="0" class="table  table-bordered" id="example">
					<p>
					<a href="add_member.php" class="btn btn-success"><i class="icon-plus"></i>&nbsp;Add Member</a>
						&nbsp;&nbsp;
					<a class="btn btn-info" href="import_members.php">Import Members</a>
						&nbsp;&nbsp;
					<a class="btn btn-info" href="upload/members.csv" download="Members.csv">Download Excel Sheet</a>
					</p>
                    <thead>
                        <tr>
                        	<th>Username</th>
